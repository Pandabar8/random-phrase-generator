...
const randomAnimalPicker = () => {
    return animal[Math.floor(Math.random() * animal.length)];
}

const randomAdjPicker = () => {
    return adj[Math.floor(Math.random() * adj.length)];
}

const randomVerbPicker = () => {
    return verbs[Math.floor(Math.random() * verbs.length)];
}

console.log(`My favorite animal is the ${randomAnimalPicker()}!`)

console.log(`That wedding was extremely ${randomAdjPicker()}.`)

console.log(`I would like to ${randomVerbPicker()} with her.`)
//console.log(randomAnimalPicker() + randomAdjPicker() + randomVerbPicker())